package app.apiservice.common.config;
...
@EnableJpaRepositories(basePackages = {"app.apiservice.repository.app"}, entityManagerFactoryRef = "appEntityManagerFactory", transactionManagerRef = "appTransactionManager", repositoryFactoryBeanClass = EnversRevisionRepositoryFactoryBean.class)


@EntityScan("app.apiservice.entity.app")
...
public class AppDbConfig {
    ...
    public LocalContainerEntityManagerFactoryBean appEntityManagerFactory(@Qualifier("appDataSource") DataSource dataSource, EntityManagerFactoryBuilder builder) {
        return builder.dataSource(dataSource).packages("app.apiservice.entity.app").persistenceUnit("app") // CHANGE TO CEIR
