...
@EnableJpaRepositories(basePackages = {"com.glocks.application.repository.app"}, entityManagerFactoryRef = "appEntityManagerFactory", transactionManagerRef = "appTransactionManager", repositoryFactoryBeanClass = EnversRevisionRepositoryFactoryBean.class)


@EntityScan("com.glocks.application.entity.app")
...
public class AppDbConfig {
    ...
    public LocalContainerEntityManagerFactoryBean appEntityManagerFactory(@Qualifier("appDataSource") DataSource dataSource, EntityManagerFactoryBuilder builder) {
        return builder.dataSource(dataSource).packages("com.glocks.application.entity.app").persistenceUnit("app") // CHANGE TO CEIR
