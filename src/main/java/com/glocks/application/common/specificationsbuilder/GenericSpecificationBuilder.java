package com.glocks.application.common.specificationsbuilder;


import com.glocks.application.common.db.DbFunctions;
...
public class GenericSpecificationBuilder<T> {
    ...
    public Specification<MobileDeviceRepository> notApproved(SearchCriteria searchCriteria) {
        return new Specification<MobileDeviceRepository>() {
            @Override
            public Predicate toPredicate(Root<MobileDeviceRepository> root, CriteriaQuery<?> query, CriteriaBuilder criteriaBuilder) {

                Predicate condition1 = criteriaBuilder.isNull(root.get("trcApprovedStatus"));
                Predicate condition2 = criteriaBuilder.notEqual(root.get("trcApprovedStatus"), "Approved");
                Predicate condition3 = criteriaBuilder.notEqual(root.get("trcApprovedStatus"), "Reject");
                return criteriaBuilder.or(condition1, criteriaBuilder.and(condition2, condition3));

             /*   return criteriaBuilder.or(
                        criteriaBuilder.isNull(root.get("trcApprovedStatus")),
                        criteriaBuilder.notEqual(root.get("trcApprovedStatus"), "Approved"));*/
            }
        };
    }
